...
from .views import UserView, CategoryView, SaleView, SaleItemView, SystemLogView, login, ProductView, ReceiptItemView, ReceiptView, StockMovementView
...
router.register(r'sale-items', views.SaleItemView, 'sale-items')
